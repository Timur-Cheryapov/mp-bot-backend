 ...
 * Simplified version without token usage tracking
 * 
 ...
 * 3. Handles the conversation ID for stateful chats
 * 
 ...
 */
function createStreamProcessor(conversationId) {
  let buffer = '';
...
router.post('/chat', async (req, res) => {
  try {
    ...
    // Create stream processor without token tracking
